...
;(function($){
    $.fn.pgwSlider = function(options) {
        ...
        var fadeElement = function(element) {
            ...
            // Update list items
            pgwSlider.plugin.find('.ps-list > li').css('border', '2px solid #fff');
            pgwSlider.plugin.find('.ps-list > li.elt_' + element.id).css('border', '2px solid #ee1c24');
            ...
            if (pgwSlider.currentSlide > 0) {
                ...
                currentElement.css('position', 'absolute').animate({
                    ...
                    currentElement.css('position', '').css('z-index', 2).hide();	/*Прозрачность картинка*/
                });
            }
        ...
        var slideElement = function(element, direction) {
            ...
            if (pgwSlider.currentSlide == 0) {
                ...
                nextElement.css('position', 'absolute').css('left', nextOrigin).css('opacity', 1).show().animate({
                    ...
                    // Display new element
                    pgwSlider.plugin.find('.ps-list > li').css('opacity', '1');
